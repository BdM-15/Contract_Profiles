...
import pandas as pd #This is the pandas library which is used to read, clean, and transform the data.
import numpy as np #This is the numpy library which is used to support the pandas library.
import datetime #This is the datetime library which is used to support the pandas library.
import os #This is the os library which is used to support the pandas library.
import glob #This is the glob library which is used to support the pandas library.
import openpyxl
import re
...
common_folders = {
    ...
    'raw_data_folder': r'C:\PyProjects\OSBP Insights\data\raw',
    
    'raw_acc_ri_data_source_file': r'C:\PyProjects\OSBP Insights\data\raw\raw_acc_ri_data_source_file.xlsx',
    'raw_army_data_source_file': r'C:\PyProjects\OSBP Insights\data\raw\raw_army_data_source_file.xlsx',
    ...
    'interim_data_source_folder': r'C:\PyProjects\OSBP Insights\data\interim',
    'interim_data_source_file': r'C:\PyProjects\OSBP Insights\data\interim\acc-ri_data_source.csv',
    'interim_army_data_source_folder': r'C:\PyProjects\OSBP Insights\data\interim',
    'interim_army_data_source_file': r'C:\PyProjects\OSBP Insights\data\interim\army_data_source.csv',
    ...
    'inights_folder': r'C:\PyProjects\OSBP Insights\data\processed',
    
    'insight_unrestricted_awarded_to_sb_folder': r'C:\PyProjects\OSBP Insights\data\processed\unrestricted_awarded_to_sb',
    'insight_unrestricted_awarded_to_sb_file': r'C:\PyProjects\OSBP Insights\data\processed\unrestricted_awarded_to_sb\insights_target1.csv',
    
    'insight_sbsa_with_potential_for_socio_set_aside_folder': r'C:\PyProjects\OSBP Insights\data\processed\sbsa_with_potential_for_socio_set_asides',
    'insight_sbsa_with_potential_for_socio_set_aside_file': r'C:\PyProjects\OSBP Insights\data\processed\sbsa_with_potential_for_socio_set_asides.csv',
    
    'insight_8a_with_exit_before_expiration_folder': r'C:\PyProjects\OSBP Insights\data\processed\8a_with_exit_before_expiration',
    'insight_8a_with_exit_before_expiration_file': r'C:\PyProjects\OSBP Insights\data\processed\8a_with_exit_before_expira.csv',
    ...
    'contract_profiles_folder': r'C:\PyProjects\OSBP Insights\reports\contract_profiles',
    'contract_profiles_template_file': r'C:\PyProjects\OSBP Insights\reports\contract_profiles\template_contract_profile.docx',
    'completed_profiles_folder': r'C:\PyProjects\OSBP Insights\reports\contract_profiles\completed_profiles',
    ...
    'wosb_naics_list' : r'C:\PyProjects\OSBP Insights\references\wosb_naics\wosb_naics_list.csv',
    ...
    'nmr_waiver_list' : r'C:\PyProjects\OSBP Insights\references\nmr_class_waivers\nmr_waiver_list.csv',
    # The Size Standard list comes from the SBA website and is used to identify the size standard for each NAICS code.
    'size_standard_list' : r'C:\PyProjects\OSBP Insights\references\size_standards\size_standards_list.csv',
    'forecast_folder' : r'C:\PyProjects\OSBP Insights\references\forecast_listing',
    'osbp_forecast_file' : r'C:\PyProjects\OSBP Insights\references\forecast_listing\osbp_forecast.csv',
    'amc_forecast_file' : r'C:\PyProjects\OSBP Insights\references\forecast_listing\amc_forecast.csv',
    'hyperlinks_folder' : r'C:\PyProjects\OSBP Insights\references\hyperlinks',
    'hyperlinks_file' : r'C:\PyProjects\OSBP Insights\references\hyperlinks\hyperlinks_listing.csv',
}
